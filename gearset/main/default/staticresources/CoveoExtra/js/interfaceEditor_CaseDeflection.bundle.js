...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "CaseDeflectionEvents", function() { return /* reexport */ ts["CaseDeflectionEvents"]; });
__webpack_require__.d(__webpack_exports__, "CaseDeflection", function() { return /* reexport */ ts["CaseDeflection"]; });
...
__webpack_require__.d(__webpack_exports__, "CaseDeflectionNode", function() { return /* reexport */ CaseDeflectionNode_CaseDeflectionNode; });

// EXTERNAL MODULE: ./src/modules/caseDeflection/ts/index.ts
...
// EXTERNAL MODULE: ./src/modules/caseDeflection/ts/CaseDeflection.ts + 3 modules
var CaseDeflection = __webpack_require__(102);

// CONCATENATED MODULE: ./src/modules/caseDeflection/interfaceEditor/CaseDeflectionNode.ts
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var CaseDeflectionNode_CaseDeflectionNode = /** @class */ (function (_super) {
    __extends(CaseDeflectionNode, _super);
    function CaseDeflectionNode(node, parser) {
        var _this = _super.call(this, node, parser, CaseDeflection["a" /* CaseDeflection */]) || this;
        _this.node = node;
        _this.isHidden = true;
        _this.isDeletable = false;
        return _this;
    }
    CaseDeflectionNode.match = function (node) {
        return external_$_(node).hasClass(Coveo.Component.computeCssClassNameForType(CaseDeflection["a" /* CaseDeflection */].ID));
    };
    CaseDeflectionNode.prototype.getType = function () {
        return CaseDeflection["a" /* CaseDeflection */].ID;
    };
    CaseDeflectionNode.priority = external_Coveo_["InterfaceEditor"].ComponentNode.priority + 1;
    return CaseDeflectionNode;
}(external_Coveo_["InterfaceEditor"].ComponentNode));

external_Coveo_["InterfaceEditor"].Parser.addNodeMatcher(CaseDeflectionNode_CaseDeflectionNode);

// CONCATENATED MODULE: ./src/modules/caseDeflection/interfaceEditor/InterfaceEditorExtension.ts
