...
module.exports = "<svg viewBox=\"0 0 13 13\" xmlns=\"http://www.w3.org/2000/svg\"><g><path d=\"m0 .05446421 13.2302246-.05446421-5.1328965 4.82505531-.12313645 8.31155399-3.31868579-2.5443468.14271201-5.71511099z\"></path><path d=\"m0 .05446421 13.2302246-.05446421-5.1328965 4.82505531-.12313645 8.31155399-3.31868579-2.5443468.14271201-5.71511099z\"></path></g></svg>"
...
module.exports = JSON.parse("{\"FilterButtonButton_activateTooltip_caption\":{\"en\":\"Open filters\"},\"FilterButtonButton_deactivateTooltip_caption\":{\"en\":\"Close filters\"},\"FilterButtonButton_disabledTooltip_caption\":{\"en\":\"No filters\"}}");
...
__webpack_require__.d(__webpack_exports__, "FilterButton", function() { return /* reexport */ FilterButton_FilterButton; });
__webpack_require__.d(__webpack_exports__, "UserActionsButton", function() { return /* reexport */ UserActionsButton["a" /* UserActionsButton */]; });
__webpack_require__.d(__webpack_exports__, "CommunitySearchboxEvent", function() { return /* reexport */ StandaloneSearchbox["a" /* CommunitySearchboxEvent */]; });
__webpack_require__.d(__webpack_exports__, "StandaloneSearchbox", function() { return /* reexport */ StandaloneSearchbox["b" /* StandaloneSearchbox */]; });
__webpack_require__.d(__webpack_exports__, "CommunityStateManager", function() { return /* reexport */ CommunityStateManager["a" /* CommunityStateManager */]; });
__webpack_require__.d(__webpack_exports__, "cacheQuickActionAPI", function() { return /* reexport */ cacheQuickActionAPI; });
__webpack_require__.d(__webpack_exports__, "ActionButton", function() { return /* reexport */ ActionButton["a" /* ActionButton */]; });
__webpack_require__.d(__webpack_exports__, "CopyToClipboard", function() { return /* reexport */ CopyToClipboard["a" /* CopyToClipboard */]; });
__webpack_require__.d(__webpack_exports__, "UserActions", function() { return /* reexport */ UserActions["a" /* UserActions */]; });
__webpack_require__.d(__webpack_exports__, "UserActivity", function() { return /* reexport */ UserActivity["a" /* UserActivity */]; });
__webpack_require__.d(__webpack_exports__, "QueryList", function() { return /* reexport */ QueryList["a" /* QueryList */]; });
__webpack_require__.d(__webpack_exports__, "ClickedDocumentList", function() { return /* reexport */ ClickedDocumentList["a" /* ClickedDocumentList */]; });
__webpack_require__.d(__webpack_exports__, "ToggleActionButton", function() { return /* reexport */ ToggleActionButton["a" /* ToggleActionButton */]; });
__webpack_require__.d(__webpack_exports__, "UserProfileModel", function() { return /* reexport */ UserProfileModel["a" /* UserProfileModel */]; });
__webpack_require__.d(__webpack_exports__, "ViewedByCustomer", function() { return /* reexport */ ViewedByCustomer["a" /* ViewedByCustomer */]; });
...
// EXTERNAL MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/ActionButton/StatefulActionButton.js
var StatefulActionButton = __webpack_require__(118);

// EXTERNAL MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/ActionButton/ToggleableButton.js
var ToggleableButton = __webpack_require__(92);

// CONCATENATED MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/ActionButton/DisableableButton.js
...
// EXTERNAL MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/ActionButton/ToggleActionButton.js
var ToggleActionButton = __webpack_require__(134);

// CONCATENATED MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/ActionButton/DisableableToggleActionButton.js
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DisableableToggleActionButton_DisableableToggleActionButton = /** @class */ (function (_super) {
    ...
    function DisableableToggleActionButton(element, options, bindings) {
        ...
        _this.options = options;
        _this.bindings = bindings;
        _this.options = external_window_Coveo_["ComponentOptions"].initComponentOptions(element, DisableableToggleActionButton, options);
        _this.createInnerButton(bindings);
        return _this;
    }
    /**
    ...
    DisableableToggleActionButton.prototype.createInnerButton = function (bindings) {
        this.deactivatedState = new ToggleableButton["b" /* ToggleDeactivatedState */](this);
        this.disabledState = new DisabledState(this);
        this.activatedState = new ToggleableButton["a" /* ToggleActivatedState */](this);
        this.innerStatefulActionButton = new StatefulActionButton["a" /* StatefulActionButton */](this.element, {
            initialState: this.deactivatedState,
...
DisableableToggleActionButton_DisableableToggleActionButton.ID = 'DisableableToggleActionButton';
DisableableToggleActionButton_DisableableToggleActionButton.ACTIVATED_CLASS_NAME = 'coveo-toggleactionbutton-activated';
DisableableToggleActionButton_DisableableToggleActionButton.options = Object.assign(Object.assign({}, ToggleActionButton["a" /* ToggleActionButton */].options), { disabledTooltip: external_window_Coveo_["ComponentOptions"].buildStringOption(), disabledIcon: external_window_Coveo_["ComponentOptions"].buildStringOption() });
external_window_Coveo_["Initialization"].registerAutoCreateComponent(DisableableToggleActionButton_DisableableToggleActionButton);


// EXTERNAL MODULE: ./src/components/search-ui/FilterButton/filterIcon.svg
var filterIcon = __webpack_require__(136);
var filterIcon_default = /*#__PURE__*/__webpack_require__.n(filterIcon);

// CONCATENATED MODULE: ./src/components/search-ui/FilterButton/FacetPositionerUtils.ts
/**
 * Class representing CSS cartesian coordinates using `top` and `left` style attributes.
 */
var CssCoordinates = /** @class */ (function () {
    function CssCoordinates(left, top) {
        this.left = !isNaN(parseInt(left)) ? left : undefined;
        this.top = !isNaN(parseInt(top)) ? top : undefined;
    }
    /**
     * Returns true if the provided coordinates match the object's coordinates.
     * @param otherCoordinates the coordinates to compare to the object
     */
    CssCoordinates.prototype.isSameCoordinates = function (otherCoordinates) {
        return this.left === otherCoordinates.left && this.top === otherCoordinates.top;
    };
    return CssCoordinates;
}());

/**
 * Move the facetContainer below the filterButton.
 * @param filterButton the button that opened the facet dropdown
 * @param facetContainer the dropdown containing the facets, the one to move.
 */
function updateFacetContainerStyle(filterButton, facetContainer) {
    var newCoordinates = computeFacetContainerCoordinates(filterButton.getBoundingClientRect(), facetContainer.getBoundingClientRect());
    facetContainer.style.left = newCoordinates.left;
    facetContainer.style.top = newCoordinates.top;
    return newCoordinates;
}
function computeFacetContainerCoordinates(filterButtonPosition, facetContainerPosition) {
    var leftOffset = Math.round(filterButtonPosition.left - facetContainerPosition.width + filterButtonPosition.width);
    var topOffset = Math.round(filterButtonPosition.top + filterButtonPosition.height);
    return new CssCoordinates(leftOffset + "px", topOffset + "px");
}

// CONCATENATED MODULE: ./src/components/search-ui/FilterButton/FacetObserver.ts


/**
 * Observe a facet and fire events on an element when the former disappear or move.
 */
var FacetObserver_FacetObserver = /** @class */ (function () {
    /**
     * Create a new instance of FacetObserver.
     * @param element The element where facet change events are dispatched.
     * @param facetColumn the element to observe.
     */
    function FacetObserver(element, facetColumn) {
        this.element = element;
        this.facetColumn = facetColumn;
        this._lastCoordinates = new CssCoordinates();
        new MutationObserver(this.onFacetColumnStyleMutation(facetColumn)).observe(this.facetColumn, {
            attributes: true,
            attributeFilter: ['style'],
        });
    }
    /**
     * Check if the facetColumn observed is visible.
     * @returns {boolean} true if visible, false otherwise.
     */
    FacetObserver.prototype.isFacetColumnVisible = function () {
        return this.facetColumn.style.display !== 'none';
    };
    FacetObserver.prototype.isAnyFacetEnabled = function () {
        return this.facetColumn.querySelectorAll(FacetObserver.FacetEnabledSelector).length > 0;
    };
    /**
     * Sets the last coordinates applied to the facet column.
     * @param transformApplied a valid transform string.
     */
    FacetObserver.prototype.setLastCoordinatesApplied = function (coordinatesApplied) {
        this._lastCoordinates = coordinatesApplied;
    };
    /**
     * Clear the last coordinates applied to the facet column.
     */
    FacetObserver.prototype.clearCoordinatesApplied = function () {
        this._lastCoordinates = new CssCoordinates();
    };
    FacetObserver.prototype.onFacetColumnStyleMutation = function (facetColumn) {
        var _this = this;
        return function (mutations) {
            if (_this.hasFacetColumnDisappeared(mutations)) {
                _this.element.dispatchEvent(new CustomEvent(FacetObserver.FacetDisappearedEventName, { detail: facetColumn }));
            }
            if (_this.hasFacetColumnPositioningChanged(mutations)) {
                _this.element.dispatchEvent(new CustomEvent(FacetObserver.FacetMovedEventName, { detail: facetColumn }));
            }
        };
    };
    FacetObserver.prototype.hasFacetColumnPositioningChanged = function (mutations) {
        return (this.hasFacetColumnMutated(mutations) &&
            !this._lastCoordinates.isSameCoordinates(new CssCoordinates(mutations[0].target.style.left, mutations[0].target.style.top)));
    };
    FacetObserver.prototype.hasFacetColumnDisappeared = function (mutations) {
        return this.hasFacetColumnMutated(mutations) && mutations[0].target.style.display === 'none';
    };
    FacetObserver.prototype.hasFacetColumnMutated = function (mutations) {
        return (mutations.length > 0 &&
            mutations[0].type === 'attributes' &&
            mutations[0].attributeName === 'style' &&
            mutations[0].target === this.facetColumn);
    };
    FacetObserver.FacetMovedEventName = 'facetmoved';
    FacetObserver.FacetDisappearedEventName = 'facetdisappeared';
    FacetObserver.FacetContentChangedEvenName = 'facetchanged';
    FacetObserver.FacetEnabledSelector = [
        external_window_Coveo_["DynamicFacet"],
        external_window_Coveo_["DynamicFacetRange"],
        external_window_Coveo_["DynamicHierarchicalFacet"],
        external_window_Coveo_["Facet"],
        external_window_Coveo_["FacetRange"],
        external_window_Coveo_["FacetSlider"],
        external_window_Coveo_["HierarchicalFacet"],
        external_window_Coveo_["TimespanFacet"],
    ]
        .map(function (facetComponent) { return "." + external_window_Coveo_["Component"].computeCssClassName(facetComponent) + ":not(.coveo-tab-disabled):not(.coveo-hidden)"; })
        .join(', ');
    return FacetObserver;
}());
...
// EXTERNAL MODULE: ./src/components/search-ui/FilterButton/strings.json
var strings = __webpack_require__(140);
var strings_namespaceObject = /*#__PURE__*/__webpack_require__.t(strings, 2);

// EXTERNAL MODULE: ./src/utils/Translation.ts
var Translation = __webpack_require__(6);

// CONCATENATED MODULE: ./src/components/search-ui/FilterButton/FilterButton.ts
var FilterButton_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var FilterButton_FilterButton = /** @class */ (function (_super) {
    FilterButton_extends(FilterButton, _super);
    function FilterButton(element, options, bindings) {
        var _this = _super.call(this, element, FilterButton.ID, bindings) || this;
        _this.element = element;
        _this.options = options;
        _this.bindings = bindings;
        _this.element.style.display = 'none';
        /**
         * Complete FilterButton initialization once ResponsiveManager is done.
         * The FilterButton remains hidden when there are no facets.
         */
        Object(external_window_Coveo_["$$"])(_this.root).one(external_window_Coveo_["InitializationEvents"].afterInitialization, function () {
            var facetColumn = _this.root.querySelector('.coveo-facet-column');
            if (facetColumn) {
                _this.facetObserver = new FilterButton.FacetObserverClassReference(_this.element, facetColumn);
                Object(external_window_Coveo_["$$"])(_this.element).one(FacetObserver_FacetObserver.FacetDisappearedEventName, _this.handleFirstFacetDisappearedEvent.bind(_this));
            }
        });
        return _this;
    }
    Object.defineProperty(FilterButton.prototype, "facetDropdownHeader", {
        get: function () {
            if (!this._facetDropdownHeader) {
                this._facetDropdownHeader = this.root.querySelector('.coveo-facet-dropdown-header');
            }
            return this._facetDropdownHeader;
        },
        enumerable: true,
        configurable: true
    });
    FilterButton.prototype.handleFacetDisappearedEvent = function () {
        this.toggleActionButton.setActivated(false);
    };
    FilterButton.prototype.handleFirstFacetDisappearedEvent = function () {
        if (this.facetDropdownHeader) {
            this.element.style.display = '';
            this.createInnerButton(this.bindings);
            this.element.addEventListener(FacetObserver_FacetObserver.FacetDisappearedEventName, this.handleFacetDisappearedEvent.bind(this));
            this.element.addEventListener(FacetObserver_FacetObserver.FacetMovedEventName, this.handleFacetMovedEvent.bind(this));
            Object(external_window_Coveo_["$$"])(this.root).on(external_window_Coveo_["QueryEvents"].deferredQuerySuccess, this.handleQuerySuccess.bind(this));
            this.element.onwheel = this.preventScrollingWhenActivated.bind(this);
        }
    };
    FilterButton.prototype.handleQuerySuccess = function () {
        if (!this.facetObserver.isAnyFacetEnabled()) {
            this.toggleActionButton.disable();
        }
        else if (this.toggleActionButton.isDisabled()) {
            this.toggleActionButton.enable();
        }
    };
    FilterButton.prototype.handleFacetMovedEvent = function (event) {
        if (this.facetObserver.isFacetColumnVisible()) {
            this.facetObserver.setLastCoordinatesApplied(FilterButton.updateFacetContainerStyleReference(this.element, event.detail));
        }
    };
    FilterButton.prototype.preventScrollingWhenActivated = function (event) {
        if (this.toggleActionButton.isActivated()) {
            event.preventDefault();
            // TODO: https://coveord.atlassian.net/browse/SFINT-3285
        }
    };
    FilterButton.prototype.proxyClickEvent = function () {
        this.facetDropdownHeader.dispatchEvent(new Event('click'));
    };
    FilterButton.prototype.createInnerButton = function (bindings) {
        var _this = this;
        this.toggleActionButton = new FilterButton.ToggleActionButtonClassReference(this.element, {
            deactivateIcon: Icons["b" /* closeIcon */],
            activateIcon: filterIcon_default.a,
            disabledIcon: filterIcon_default.a,
            activateTooltip: Object(external_window_Coveo_["l"])('FilterButtonButton_activateTooltip_caption'),
            disabledTooltip: Object(external_window_Coveo_["l"])('FilterButtonButton_disabledTooltip_caption'),
            deactivateTooltip: Object(external_window_Coveo_["l"])('FilterButtonButton_deactivateTooltip_caption'),
            activate: function () {
                _this.proxyClickEvent();
            },
            deactivate: function () {
                if (_this.facetObserver.isFacetColumnVisible()) {
                    _this.proxyClickEvent();
                }
                _this.facetObserver.clearCoordinatesApplied();
            },
        }, bindings);
    };
    FilterButton.ID = 'FilterButton';
    FilterButton.ToggleActionButtonClassReference = DisableableToggleActionButton_DisableableToggleActionButton;
    FilterButton.FacetObserverClassReference = FacetObserver_FacetObserver;
    FilterButton.updateFacetContainerStyleReference = updateFacetContainerStyle;
    FilterButton.options = {};
    return FilterButton;
}(external_window_Coveo_["Component"]));

external_window_Coveo_["Initialization"].registerAutoCreateComponent(FilterButton_FilterButton);
// Load strings
...
// EXTERNAL MODULE: ./src/modules/standaloneSearchbox/ts/StandaloneSearchbox.ts
var StandaloneSearchbox = __webpack_require__(131);
...
// CONCATENATED MODULE: ./src/components/search-ui/CachedQuickActionAPI/CachedQuickActionAPI.ts


/**
 * Create a caching proxy wraper around the quick action api.
 * @param quickActionApi The Quick Action API reference that will be wrapped by the caching proxy.
 * @param rootInterface The root search-ui interface on which the proxy listen to clear his cache.
 */
function cacheQuickActionAPI(quickActionApi, rootInterface) {
    return cache(quickActionApi, new Set(['getAvailableActions']), function (invalidate) {
        Object(external_window_Coveo_["$$"])(rootInterface).on(ResultActionsEvents["a" /* ResultActionsEvents */].onTabFocused, function () {
            invalidate();
        });
    });
}
/**
 * Create a caching proxy against `obj`.
 * @param obj The object to wrap with the caching proxy.
 * @param cachedMethods The Set of cached methods.
 * @param callback Callback that tell to the cache when to invalidate it stored values.
 */
function cache(obj, cachedMethods, callback) {
    var objProps = new Set(Object.keys(obj));
    var responses = new Map();
    // Given invalidate hook to the callback.
    callback(responses.clear.bind(responses));
    /* eslint-disable compat/compat */
    return new Proxy(obj, {
        get: function (target, prop) {
            return isCachedMethod(prop, cachedMethods, objProps)
                ? getProxyMethod(prop, responses, target[prop])
                : target[prop];
        },
    });
...
/**
 * Get the response if available otherwise set it for `methodId`.
 * @param methodId The method identifier.
 * @param dict The method response disctionnary.
 * @param call The call that will fill the dictionnary slot if needed.
 */
function getProxyMethod(methodId, dict, call) {
    return function () { return (dict.has(methodId) ? dict : dict.set(methodId, call())).get(methodId); };
}
/**
 * Tell whether or not the method id is cached.
 * @param methodId The method identifier.
 * @param cachedMethods A set of method that need to be cached.
 * @param objProps A set that contains all obj method ids.
 */
function isCachedMethod(methodId, cachedMethods, objProps) {
    return cachedMethods.has(methodId) && objProps.has(methodId);
}

// EXTERNAL MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/ActionButton/ActionButton.js
var ActionButton = __webpack_require__(36);

// EXTERNAL MODULE: ./node_modules/coveo-search-ui-extensions/bin/es6/components/CopyToClipboard/CopyToClipboard.js + 2 modules
var CopyToClipboard = __webpack_require__(75);
...
// CONCATENATED MODULE: ./src/modules/search/ts/lightning.ts
